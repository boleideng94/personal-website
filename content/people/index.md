...
<div style="display:flex; flex-wrap:wrap; gap:20px; align-items:stretch;">
  <div style="flex:1 1 320px; max-width:calc(50% - 20px); border:1px solid #eee; border-radius:12px; padding:16px; box-shadow:0 1px 4px rgba(0,0,0,0.04);">
    ...
    <div style="font-size:0.95rem; font-weight:600; text-align:center;">Xinyi Yang</div>
    <div style="text-align:center; color:#666; margin-bottom:8px; font-size:0.86rem;">PhD in Robotics</div>
  ...
  <div style="flex:1 1 320px; max-width:calc(50% - 20px); border:1px dashed #eee; border-radius:12px; padding:16px;">
    ...
    <div style="font-size:0.95rem; font-weight:600; text-align:center;">Student Name</div>
    <div style="text-align:center; color:#666; margin-bottom:8px; font-size:0.86rem;">PhD Student</div>
    <div style="font-size:0.86rem; line-height:1.35;">
      Short intro goes here.
    </div>
    <div style="margin-top:8px; font-size:0.86rem; color:#555;">
